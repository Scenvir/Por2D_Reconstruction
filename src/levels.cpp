...
level.spawn = {{101, 141}, Direction::Up};
level.exit = Body{{421, 381}, Direction::Right};
level.map.fill(Tile::Solid, 2, 2, 30, 2);
level.map.fill(Tile::Solid, 2, 3, 6, 3);
level.map.fill(Tile::PortalSurface, 7, 3, 9, 3);
level.map.fill(Tile::Solid, 10, 3, 30, 3);
level.map.fill(Tile::Solid, 2, 4, 3, 4);
level.map.fill(Tile::Solid, 10, 4, 10, 4);
level.map.fill(Tile::Solid, 18, 4, 19, 4);
level.map.fill(Tile::Solid, 29, 4, 30, 4);
level.map.fill(Tile::Solid, 2, 5, 3, 5);
level.map.fill(Tile::Solid, 8, 5, 8, 5);
level.map.fill(Tile::Solid, 10, 5, 10, 5);
level.map.fill(Tile::Solid, 18, 5, 19, 5);
level.map.fill(Tile::Solid, 29, 5, 30, 5);
level.map.fill(Tile::Solid, 2, 6, 3, 6);
level.map.fill(Tile::Solid, 7, 6, 8, 6);
level.map.fill(Tile::Solid, 10, 6, 10, 6);
level.map.fill(Tile::Solid, 18, 6, 19, 6);
level.map.fill(Tile::Solid, 29, 6, 30, 6);
level.map.fill(Tile::Solid, 2, 7, 3, 7);
level.map.fill(Tile::Solid, 18, 7, 19, 7);
level.map.fill(Tile::Solid, 29, 7, 30, 7);
level.map.fill(Tile::Solid, 2, 8, 3, 8);
level.map.fill(Tile::Solid, 14, 8, 14, 8);
level.map.fill(Tile::Solid, 18, 8, 19, 8);
level.map.fill(Tile::Solid, 29, 8, 30, 8);
level.map.fill(Tile::Solid, 2, 9, 2, 9);
level.map.fill(Tile::PortalSurface, 3, 9, 3, 9);
level.map.fill(Tile::Solid, 14, 9, 14, 9);
level.map.fill(Tile::PortalSurface, 18, 9, 18, 9);
level.map.fill(Tile::Solid, 19, 9, 19, 9);
level.map.fill(Tile::Solid, 29, 9, 30, 9);
level.map.fill(Tile::Solid, 2, 10, 2, 10);
level.map.fill(Tile::PortalSurface, 3, 10, 3, 10);
level.map.fill(Tile::Solid, 5, 10, 16, 10);
level.map.fill(Tile::PortalSurface, 18, 10, 18, 10);
level.map.fill(Tile::Solid, 19, 10, 19, 10);
level.map.fill(Tile::Solid, 29, 10, 30, 10);
level.map.fill(Tile::Solid, 2, 11, 2, 11);
level.map.fill(Tile::PortalSurface, 3, 11, 3, 11);
level.map.fill(Tile::Solid, 6, 11, 9, 11);
level.map.fill(Tile::PortalSurface, 10, 11, 12, 11);
level.map.fill(Tile::Solid, 13, 11, 14, 11);
level.map.fill(Tile::PortalSurface, 18, 11, 18, 11);
level.map.fill(Tile::Solid, 19, 11, 19, 11);
level.map.fill(Tile::Solid, 29, 11, 30, 11);
level.map.fill(Tile::Solid, 2, 12, 4, 12);
level.map.fill(Tile::Solid, 6, 12, 8, 12);
level.map.fill(Tile::Solid, 18, 12, 19, 12);
level.map.fill(Tile::Solid, 29, 12, 30, 12);
level.map.fill(Tile::Solid, 2, 13, 4, 13);
level.map.fill(Tile::Solid, 17, 13, 19, 13);
level.map.fill(Tile::Solid, 29, 13, 30, 13);
level.map.fill(Tile::Solid, 2, 14, 4, 14);
level.map.fill(Tile::Solid, 11, 14, 19, 14);
level.map.fill(Tile::Solid, 29, 14, 30, 14);
level.map.fill(Tile::Solid, 2, 15, 4, 15);
level.map.fill(Tile::Solid, 10, 15, 19, 15);
level.map.fill(Tile::Solid, 29, 15, 30, 15);
level.map.fill(Tile::Solid, 2, 16, 4, 16);
level.map.fill(Tile::Solid, 6, 16, 19, 16);
level.map.fill(Tile::Solid, 29, 16, 30, 16);
level.map.fill(Tile::Solid, 2, 17, 4, 17);
level.map.fill(Tile::Solid, 7, 17, 7, 17);
level.map.fill(Tile::Solid, 29, 17, 30, 17);
level.map.fill(Tile::Solid, 2, 18, 4, 18);
level.map.fill(Tile::Solid, 7, 18, 7, 18);
level.map.fill(Tile::Solid, 29, 18, 30, 18);
level.map.fill(Tile::Solid, 2, 19, 4, 19);
level.map.fill(Tile::Solid, 29, 19, 30, 19);
level.map.fill(Tile::Solid, 2, 20, 5, 20);
level.map.fill(Tile::PortalSurface, 6, 20, 8, 20);
level.map.fill(Tile::Solid, 9, 20, 30, 20);
level.map.fill(Tile::Solid, 2, 21, 30, 21);
    return level;
}
